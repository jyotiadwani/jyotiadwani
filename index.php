...
<head>
    <!-- Basic Page Needs
    ================================================== -->
    <title>Jyoti Adwani</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Jyoti Adwani">
      <meta name="keywords" content="Jyoti Adwani">
    <meta name="author" content="Jyoti Adwani">
...
<body>
    ...
    <div id="frontpage"> 
        ...
        <img src="front-image.jpg" class="front-img img-responsive" alt ="Front-image"><!--IMAGE FOR FRONT SCREEN-->
        <h1>Jyoti <span class="invert">Adwani</span></h1><!--PROFILE NAME-->
         <div class="frontclick"><img src="click.png" alt="" class="img-responsive"><span class="pulse"></span></div>
    </div>
        ...
        <div id="content" class="row hidden">
            <div class="col-sm-4">
                ...
                <div id="namecard" class="namecard">
                    <div class="shadow-img"></div>
                    <h1 class="maintitle">Jyoti <span class="invert">Adwani</span></h1><!--PROFILE NAME-->
                    
                    <img id="profile-img" class="profile-img transparent" src="profile-thum.png" alt="profile-image"/><!--PROFILE IMAGE-->
                </div><!--/#namecard-->
                <!--menu-->
                <div id="menu-container">
                    ...
                    <div class="social-menu-container">
                        <ul class="social-menu no-padding">                     
                            <li><a href="https://www.facebook.com/jyoti.adwani.52"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="https://www.instagram.com/jyoti_adwani_789"><i class="fa fa-instagram"></i></a></li>
                            <li><a href="https://www.snapchat.com/add/jyotiadwani7890"><i class="fa fa-snapchat"></i></a></li>
                ...
                <ul class="page-container no-padding">
                    ...
                    <li id="home" class="selected">
                        ...
                        <div class="description hidden">
                            ...
                            <div class="fade-text transparent">
                                <!--DESCRIPTION ON HOME-->
                                <div class="strong-text">Hello, I am <span>Jyoti Adwani</span></div>
                                <div class="focus-text"><span>Senior CRM @ </span><span>Nebula</span></div>
                                <p class="large-paragraph">Sweet as sugar,Hard as an ice Cute Enough to make you look twice</p>         
                            ...
                            <ul class="personal-info">
                                <li class="rotate-out rotated"><label>Name</label><span>Jyoti Adwani</span></li>                     
                                <li class="rotate-out rotated"><label>Email</label><span>jyotiadwani7890@gmail.com</span></li>  
                    ...
                    <li id="resume" class="hidden">
                        <div class="title-container">
                            <div class="shadow-img"></div>
                            <h2 class="rotate-out rotated"><span class="invert">Resume Of</span> Jyoti Adwani</h2> <!--RESUME TITLE-->
                        </div>
                            ...
                            <div class='tabs tabs_animate'>
                                ...
                                <div id='tab-1'>
                                    ...
                                    <ul class="skills-list no-padding">
                                        <li class="row">
                                            <div class="col-xs-2"><div class="fw-mid">Team Handling</div></div>
                                            <div class="col-xs-9">
                                                <div class="bar">
                                        ...
                                        <li class="row">
                                            <div class="col-xs-2"><div class="fw-mid">Event Management</div></div>
                                            <div class="col-xs-9">
                                                <div class="bar">
                                        ...
                                        <li class="row">
                                            <div class="col-xs-2"><div class="fw-mid">Client Relationships</div></div>
                                            <div class="col-xs-9">
                                                <div class="bar">
                                ...
                                <div id='tab-2'>
                                    ...
                                    <ul class="education-class">
                                        <li>
                                            <!--EDUCATION LIST ITEM-->
                                            <h4 class="title">Bachelors in Commerce<i class="fa fa-sort-desc pull-right"></i></h4>
                                            <div class="list-content">
                                                <h5 class="title">SM Patel Institute of Commerce <span class="list-year">(2012 - 2015)</span></h5>
                                                <p>I've done my bachelors in commerce degree from SM Patel Institute of Commerce (Ahmedabad)</p><!--EDUCATION LIST DETAILS-->
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="list-content">
                                                <h5 class="title">Best High School<span class="list-year">(1997 - 2012)</span></h5>
                                                <p>I've done my schooling from Best High School (Ahmedabad)</p><!--EDUCATION LIST DETAILS-->
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div id='tab-3'>
                                    ...
                                    <ul class="employment-class tab-cont">
                                        <li>
                                            ...
                                            <h4>Senior Client Relationship Manager <span class="year">2015 - Present</span></h4>
                                            <h5>Nebula</h5>
                                            <p>Nebula is the coming together of the best minds in business where every founder member is an accomplished name with a long standing legacy of running successful businesses, be it real estate development, hospitality, timeshare and holidays. The core think tank leading the group have a proven track record in creating enterprises of repute namely</p> </li>
                                ...
                                <div class="folio-container">
                                    <ul class="folio-item"><!--PORTFOLIO INDIVIDAUAL ITEM-->
                                        <li class="view view-first photography">  
                                            <img src="folio/logs.jpg" alt="logs" /><!--PORTFOLIO INDIVIDAUAL ITEM IMAGE--> 
                                            <div class="mask">  
                                        ...
                                        <li class="view view-second commercial"><!--PORTFOLIO INDIVIDAUAL ITEM-->
                                          <img src="folio/book.jpg" alt="book" /><!--PORTFOLIO INDIVIDAUAL ITEM IMAGE--> 
                                            <div class="mask"></div>
                                            <div class="content">
                                        ...
                                        <li class="view view-tenth photography"> <!--PORTFOLIO INDIVIDAUAL ITEM--> 
                                             <img src="folio/beach.jpg" alt="beach" /> <!--PORTFOLIO INDIVIDAUAL ITEM IMAGE-->  
                                             <div class="mask">  
                                        ...
                                        <li class="view view-second commercial"><!--PORTFOLIO INDIVIDAUAL ITEM-->
                                          <img src="folio/guy.jpg" alt="guy" /><!--PORTFOLIO INDIVIDAUAL ITEM IMAGE--> 
                                            <div class="mask"></div>
                                            <div class="content">
                                        ...
                                        <li class="view view-first potrait"><!--PORTFOLIO INDIVIDAUAL ITEM-->  
                                             <img src="folio/illustration.jpg" alt="illustration" /><!--PORTFOLIO INDIVIDAUAL ITEM IMAGE-->   
                                             <div class="mask">  
                                                 <h2>New York</h2>                                   
            ...
            <!--  <h6 class="copyright-text">Copyright © 2015 Jyoti Adwani</h6> --> <!--if anyone wants copyright Texts--> 
        </div>
    </div><!--/.container -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="folio/logs.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
                </div>
    ...
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="folio/book.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
                </div>
                <div class="modal-footer">
                    <div class="mf-content">
    ...
    <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="folio/guy.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
                </div>
                <div class="modal-footer">
                    <div class="mf-content">
    ...
    <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="folio/illustration.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
                </div>
                <div class="modal-footer">
                    <div class="mf-content">
    ...
    <div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="folio/beach.jpg" class="img-responsive" alt="modal-image"><!--PORTFOLIO MODAL IMAGE-->
                </div>
                <div class="modal-footer">
                    <div class="mf-content">
    ...
    <!--javascript files
    =============================================================-->
    <script type="text/javascript" src="jQueryTween-aio-min.js"></script> <!-- JQUERY Tween Plugin -->
    <script type="text/javascript" src="jquery.tabslet.min.js"></script> <!-- JQUERY Tab plugin-->     
    <script type="text/javascript" src="progressbar.min.js"></script> <!-- JQUERY Progressbar Plugin-->
    <script type="text/javascript" src="jquery.simple-text-rotator.min.js"></script> <!-- JQUERY Text Rotator-->
    <script type="text/javascript" src="bootstrap.min.js"></script> <!-- Bootstrap file-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBPNkCVoBW_Jzl6x-hgGU6e7QW1QMwKles"></script>
    <script type="text/javascript" src='isotope.pkgd.min.js'></script> <!--SCRIPTS FOR PORTFOLIO IMAGE'S ANIMATION-->
